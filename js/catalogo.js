// ============================================================
// catalogo.js - Logica de la interfaz (UI) de index.html
// ============================================================
// Este archivo es responsable de:
//   1. Renderizar las tarjetas de producto (cuadricula).
//   2. Manejar los filtros: categoria, radio de ubicacion y
//      busqueda por texto.
//   3. Mostrar el modal con el detalle de un producto al hacer
//      click sobre su tarjeta.
//   4. Manejar el carrito ("bolsa de compras"): agregar un
//      producto y actualizar el numero del icono del carrito.
//
// El menu de perfil vive en interfaz.js (clase MenuPerfil), por eso no
// aparece aqui.
//
// Depende de datos.js (debe cargarse antes) y de interfaz.js (debe
// cargarse antes tambien). Ver el orden de los <script> en
// index.html.
//
...
function inicializar() {
  ...
  const menuPerfil = new MenuPerfil('profile-btn', 'profile-dropdown', window.USUARIO_ACTUAL);
